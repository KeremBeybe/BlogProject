...
string jsonData = @"[
                    {
                        ...
                        ""İl"":""İstanbul"",
                        ""Tarih"":""12.10.2024"",
                        ""text"":""İyi ki Tanışmışız, dedirten havadurumu"",
                    }
                ]";
            ...
            {
                AddHavaCommand command = new AddHavaCommand();
                command.hava = hava;
                
                AddHavaCommand.Handler handler = new AddHavaCommand.Handler();
                var data = await handler.Handle(command,CancellationToken.None);ß
            };            